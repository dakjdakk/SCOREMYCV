...
export const metadata: Metadata = {
  ...
  title: "ScoreMyCV — Free ATS Resume Checker | CV Rewrite for ₹49",
  description:
    "Check your resume ATS score for free. See missing keywords and exactly why recruiters ignore your CV. Get your full CV professionally rewritten and download instantly for just ₹49.",
  keywords:
    "ATS resume checker, ATS score India, resume rewrite India, CV score free, ATS optimized resume, resume checker online, CV rewrite ₹49, job resume India",
  alternates: {
    canonical: SITE_URL,
  },
  openGraph: {
    ...
    url: SITE_URL,
    siteName: "ScoreMyCV",
    title: "Free ATS Score Check + CV Rewrite for ₹49 — ScoreMyCV",
    description:
      "Upload your resume. Get your free ATS score instantly. See missing keywords. Get your entire CV professionally rewritten and download the polished PDF for just ₹49.",
    images: [
      {
...
const serviceSchema = {
  ...
  description:
    "Free ATS resume score check with instant CV rewrite for ₹49. Upload your resume, get your score, missing keywords, and a fully rewritten ATS-optimised PDF instantly.",
  url: SITE_URL,
  offers: {
    "@type": "Offer",
    price: "49",
